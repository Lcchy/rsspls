...
summary = ".post-body"
# Optional CSS selector relative to `item` that supplies a media (image, video..) content to be added as an enclosure.
# The media link must be given by the `src` attribute.
media = ".example-img > a"
